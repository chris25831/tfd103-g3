...
try {
    ...
    $obj->Send['OrderResultURL']         = "https://tibamef2e.com/tfd103/g3/tfd103-g3/shopcart-checkout.html?checkout=done"; //成功導回頁面
    $obj->Send['ClientBackURL']         = "https://tibamef2e.com/tfd103/g3/tfd103-g3/shopcart-checkout.html?checkout=done";
    $obj->Send['MerchantTradeNo']   = $MerchantTradeNo;                          //訂單編號
    $obj->Send['MerchantTradeDate'] = date('Y/m/d H:i:s');                       //交易時間
    $obj->Send['TotalAmount']       = $total;                                    //交易金額
    $obj->Send['TradeDesc']         = "have a nice day";                          //交易描述
    ...
    array_push($obj->Send['Items'], array(
        'Name' => "$productName", 'Price' => (int)"$total",
